		...
		<table cellpadding="5">
			...
			<tr>
				...
				<td><input class="easyui-validatebox" type="text" name="wmName"
					value="${wm.wmName}"
					data-options="required:true,validType:'wmCount',missingMessage:'请输入仓储名称！'"></input></td>
			</tr>
			<tr>
				<td>可用数量：</td>
				<td><input class="easyui-validatebox" type="text" id="wmCount"
					name="wmCount" value="${wm.wmCount}"
