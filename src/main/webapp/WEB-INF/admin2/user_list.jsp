			...
			$('#demo_datagrid').datagrid({
				...
				frozenColumns:
					[[
						...
						{field:'userId',title:'userId',align:'center',width:200}
					]],
				columns:
					[[      
						{field:'phone',title:'phone',align:'center',width:80},
						{field:'Local',title:'Local',align:'center',width:600}
					]],
